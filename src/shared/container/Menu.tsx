...
const MENU: Array<TGroupMenu> = [
  {
    keyGroup: '1',
    groupMenu: [{ title: 'Tổng quan', to: PROTECTED_ROUTES_PATH.HOME, icon: <BsHouseDoor /> }]
  },
  {
    keyGroup: '2',
    groupMenu: [{ title: 'Bài viết', to: PROTECTED_ROUTES_PATH.NEWS, icon: <BsFilePost /> }]
  },
  {
    keyGroup: '3',
    groupMenu: [{ title: 'Sự kiện', to: PROTECTED_ROUTES_PATH.EVENTS, icon: <BsCalendarCheck /> }]
  },
  {
    keyGroup: '4',
    groupMenu: [{ title: 'Diễn đàn', to: PROTECTED_ROUTES_PATH.FORUM, icon: <BsChatText /> }]
  },
  {
    keyGroup: '5',
    groupMenu: [
  ...
  {
    keyGroup: '6',
    groupMenu: [{ title: 'Tài khoản', to: PROTECTED_ROUTES_PATH.ACCOUNT, icon: <BsPeople /> }]
  }
  // {
  //   keyGroup: '6',
